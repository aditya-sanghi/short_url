...
describe UrlRelation do
  ...
  it 'raise validation error in case of empty short version field' do
    expect { UrlRelation.create!(short_version: nil, full_version: 'ddddd') }.to raise_error(ActiveRecord::RecordInvalid)
  end
